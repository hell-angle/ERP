...
export default ({ startModal, setStartModal, startShipment }) => {
    ...
    return startModal ? (
        <div className="fixed indet-0 z-10 overflow-y-auto">
            <div className="fixed indet-0 w-full h-full bg-black opacity-40"
            ...
            <div className="flex items-center min-h-screen px-4 py-8">
                <div className="relative w-full max-w-lg p-4 mx-auto bg-white rounded-md shadow-lg">
                    <div className="flex justify-end">
                        <button 
                            className="p-2 textgray-400 rounded-md hover:bg-gray-100"
                            onClick={() =>setStartModal(false)}
                        >
                            <Str1/>
                        </button>
                    ...
                    <div className="max-w-sm mx-auto py-3 space-y-3 text-center">
                        <h4 className="text font-medium text-gray-800">
                            Start the Shipping
                        </h4>
                        ...
                        <form onSubmit={(e) => e.preventDefault()}>
                            <div className="relative mt-3">
                                <input 
                                    ...
                                    outline-none border focus:border-indigo-600 shadow-sm rouded-lg"
                                    onChange={(e) =>
                                        setGetProduct({
                                            ...getProduct,
